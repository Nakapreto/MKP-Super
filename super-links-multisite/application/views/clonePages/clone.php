            ...
            <div class="py-1">
                <div class="row justify-content-end">
                    <div class="col-8">
                        ...
                        <p class="small"><?php TranslateHelper::printTranslate('Preencha os campos abaixo para duplicar uma página clonada')?></p>
                    </div>
                    <div class="col-4 text-right">
                        <?php
                            FormHelper::submitButtonPP(
                                $addLinksModel,
                                TranslateHelper::getTranslate( 'Salvar nova página' ),
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3 dynamicCloneField">
				                    <?php
				                    FormHelper::dynamicCloneLinkClone(
					                    $clonePageModel,
					                    'link',
