            ...
            <div class="py-1">
                <div class="row justify-content-end">
                    <div class="col-8">
                        ...
                        <p class="small"><?php TranslateHelper::printTranslate('Preencha os campos abaixo para criar um novo cookie de afiliado e/ou Popup de saída')?></p>
                    </div>
                    <div class="col-4 text-right">
                        <?php
                        FormHelper::submitButton(
                            $cookiePageModel,
                            TranslateHelper::getTranslate('Salvar configuração'),
                            [
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-5 mb-3">
                                        <?php
                                        $values = [
                                            ['selected' => true, 'text' => TranslateHelper::getTranslate('Sim (Recomendado)'), 'val' => 'enabled'],
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        <?php
                                        $values = [
                                            ['selected' => true, 'text' => TranslateHelper::getTranslate('Usuário tentar sair'), 'val' => 'exitPage'],
