                ...
                <div class="row justify-content-end">
                    <div class="col-8">
                        ...
                        <a class="btn btn-primary btn-sm"
                           href="<?=SUPER_LINKS_TEMPLATE_URL?>/<?=$keyWord?>" target="_blank"><?= TranslateHelper::getTranslate('Abrir Link') ?></a>
                    </div>
                    ...
                    <div class="card-header" id="headingFour">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button"
                                ...
                                <?php TranslateHelper::printTranslate('Opções de visualização da página e outros plugins')?>
                            </button>
                        </h2>
                    </div>
    ...
    jQuery(document).ready(function(){
        jQuery(document).on("change", "#<?=FormHelper::getFieldId($addLinksModel,'redirectType')?>", function() {
            if(jQuery(this).val() == 'facebook'){
                jQuery('.affiliateUrl').prop("disabled", false);
            }else{
                jQuery('.affiliateUrl').prop("disabled", true);
            }
        })
    })
</script>
